# portfolio_platform/settings.py
import os
import sys  # sys уже импортирован
...
INSTALLED_APPS = [
    ...
    "storages",
    # 'drf_yasg',
    # Наши приложения (ИЗМЕНЕНЫ ЗДЕСЬ)
    "apps.users.apps.UsersConfig",  # Или просто 'apps.users' если UsersConfig - стандартное имя
    "apps.projects.apps.ProjectsConfig",  # Или просто 'apps.projects'
]
...
AWS_S3_ENDPOINT_URL = os.getenv(
    "AWS_S3_ENDPOINT_URL"
)  # Для MinIO и других S3-совместимых
AWS_S3_OBJECT_PARAMETERS = {"CacheControl": "max-age=86400"}
AWS_LOCATION = "media"  # Папка внутри бакета для медиафайлов
AWS_DEFAULT_ACL = (
    None  # или 'public-read' если файлы должны быть доступны по прямой ссылке
)
